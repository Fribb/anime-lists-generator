...
@Service
@Profile("test-short")
public class AnimeListsLocalShort implements AnimeListsDataSource{

    private static final Logger LOGGER = LoggerFactory.getLogger(AnimeListsLocalShort.class);

    private final XmlMapper mapper;

    public AnimeListsLocalShort(XmlMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public AnimeLists loadData() {
        ...
        try {
            String fileContent = Files.readString(Paths.get("src/test/resources/files/anime-list-short.xml"));
