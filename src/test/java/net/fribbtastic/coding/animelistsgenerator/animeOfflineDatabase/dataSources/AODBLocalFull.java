...
@Service
@Profile("test-full")
public class AODBLocalFull implements AnimeOfflineDbDataSource {

    private static final Logger LOGGER = LoggerFactory.getLogger(AODBLocalFull.class);

    private final ObjectMapper mapper;

    public AODBLocalFull(ObjectMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public AODB loadData() {
        ...
        try {
            String fileContent = Files.readString(Paths.get("src/test/resources/files/anime-offline-database-minified.json"));
